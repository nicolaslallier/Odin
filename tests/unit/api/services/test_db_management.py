...
from src.api.services.db_management import DatabaseManagementService, QueryResult, TableInfo, TableSchema, DatabaseStats
...
class TestValidateSQL:
    ...
    def test_validate_sql_select_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_insert_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_update_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_delete_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_drop_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_truncate_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_alter_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_empty_query(self, db_management_service: DatabaseManagementService) -> None:
    ...
    def test_validate_sql_invalid_syntax(self, db_management_service: DatabaseManagementService) -> None:
...
class TestExecuteQuery:
    ...
    async def test_execute_query_destructive_with_confirmation(
        ...
        # Act
        result = await db_management_service.execute_query("DELETE FROM users WHERE id < 10", confirmed=True)
    ...
    async def test_execute_query_timeout(
        ...
        # Act
        result = await db_management_service.execute_query("SELECT * FROM large_table", confirmed=False)
...
class TestGetTableData:
    ...
    async def test_get_table_data_with_search(
        ...
        # Act
        result = await db_management_service.get_table_data("users", page=1, page_size=10, search="John")
    ...
    async def test_get_table_data_with_order_by(
        ...
        # Act
        result = await db_management_service.get_table_data("users", page=1, page_size=10, order_by="name DESC")
